...
makeLuaSprite('BScreen', '', 0, 0)
makeGraphic('BScreen', screenWidth, screenHeight,'000000')
setObjectCamera('BScreen', 'camHUD')
setProperty('BScreen.alpha', 0.5)
addLuaSprite('BScreen', false)
end
